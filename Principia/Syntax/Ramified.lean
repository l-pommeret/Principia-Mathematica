...
/-- Contextual identity `(℩x)(φx) = b`.  The description remains an
incomplete symbol: `star_14_01` binds its candidate and the continuation
asserts the displayed identity with the independently assigned ✱13·01
vocabulary. -/
