...
/-- ✱60·01, defining equation. -/ theorem star_60_01 (a : Class α) : Cl a = fun b=>Included b a := rfl
/-- ✱60·321. -/ theorem star_60_321 (a : Class α) : a=PM.Architecture.Star60Kernel.Empty ↔ Cl a=PM.Architecture.Star60Kernel.Singleton a := by
  constructor
  · rintro rfl; exact star_60_32
  · intro h; have he : Cl a PM.Architecture.Star60Kernel.Empty := star_60_3 a; rw [h] at he; exact he.symm
/-- ✱60·33. -/ theorem star_60_33 : ClEx (PM.Architecture.Star60Kernel.Empty : Class α)=PM.Architecture.Star60Kernel.Empty := by
  apply ext; intro a; constructor
  · rintro ⟨hi,x,hx⟩; exact (hi x hx).elim
  · exact False.elim
/-- ✱60·36. -/ theorem star_60_36 (a : Class α) : Proper a→Proper (ClEx a) := fun h=>⟨a,star_60_35 a h⟩
/-- ✱60·361. -/ theorem star_60_361 (a : Class α) : Proper a↔Proper (ClEx a) := by
  exact ⟨star_60_36 a,fun ⟨b,hb⟩=>let ⟨x,hx⟩:=hb.2; ⟨x,hb.1 x hx⟩⟩
/-- ✱60·362. -/ theorem star_60_362 (x : α) :
...
/-- ✱60·371. -/ theorem star_60_371 (a : Class α) (x : α) (h : a=PM.Architecture.Star60Kernel.Singleton x) :
...
/-- ✱60·38. -/ theorem star_60_38 (a : Class α) :
...
theorem star_60_39 (x y : α) : Cl (Union (PM.Architecture.Star60Kernel.Singleton x) (PM.Architecture.Star60Kernel.Singleton y)) =
  ...
  · rintro (rfl|rfl|rfl|rfl)
    ...
    · exact fun _ h=>h
/-- ✱60·52. -/ theorem star_60_52 (k : Class (Class α)) (b : Class α) :
