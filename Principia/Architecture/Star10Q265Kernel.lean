...
/-- The proof payload of ✱10·27 is exactly the already-derived canonical
✱9·21 assertion.  This is an abbreviation, not a new theorem-specific
judgement relation: the formal-implication notation introduced in ✱10 adds no
primitive rule to the calculus. -/
abbrev Star_10_27Derivation (φ ψ : Apparent Γ [.elementaryProposition]) : Prop :=
  PM.Architecture.Star921MatrixKernel.Star9CanonicalAssertion
...
def star_10_27 (φ ψ : Apparent Γ [.elementaryProposition]) :
  ...
  PM.Architecture.Star921MatrixKernel.Star9KernelAssertion.star_9_21 φ ψ

/-- The proof payload of ✱10·28 is the existing source-expanded ✱9·22
certificate.  It retains the indexed assertion and the printed ✱9·06, ✱9·08,
and ✱9·07 normalization steps without adding a constructor for ·28 itself. -/
abbrev Star_10_28Derivation (φ ψ : Apparent Γ [.elementaryProposition]) : Prop :=
  PM.Architecture.Star922Kernel.Star922KernelAssertion φ ψ
...
def star_10_28 (φ ψ : Apparent Γ [.elementaryProposition]) :
  ...
  PM.Architecture.Star922Kernel.derive φ ψ
