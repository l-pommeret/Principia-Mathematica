...
Dem.
⊢ . ✱22·33 . ⊃ ⊢ : x ∈ ẑ(φ z) ∩ ẑ(ψ z) .≡ . x ∈ ẑ(φ z) . x ∈ ẑ(ψ z) .
[✱20·3] ≡ . φ x . ψ x  (1)
⊢ . (1) . ✱20·33 . ⊃ ⊢ . Prop
...
Dem.
⊢ . ✱22·1 . ⊃ ⊢ :: α ⊂ β .≡ : x ∈ α .⊃ₓ. x ∈ β : . β ⊂ α .≡ : x ∈ β .⊃ₓ. x ∈ α : .
[✱4·38] ⊃ ⊢ :: α ⊂ β . β ⊂ α .≡ :. x ∈ α .⊃ₓ. x ∈ β : x ∈ β .⊃ₓ. x ∈ α : .
[✱10·22] ≡ :. x ∈ α .≡ₓ. x ∈ β :: ⊃ ⊢ . Prop
...
✱22·45. ⊢ : α ⊂ β . α ⊂ γ .≡ . α ⊂ β ∩ γ
Dem.
⊢ . ✱22·1 . ⊃ ⊢ :. α ⊂ β . α ⊂ γ . ≡ : x ∈ α . ⊃ₓ . x ∈ β : x ∈ α . ⊃ₓ . x ∈ γ :
[✱10·29] ≡ : x ∈ α . ⊃ₓ . x ∈ β . x ∈ γ :
[✱22·33 . ✱10·413] ≡ : x ∈ α . ⊃ₓ . x ∈ β ∩ γ :. ⊃ ⊢ . Prop
...
✱22·68. ⊢ . (α ∩ β) ∪ (α ∩ γ) = α ∩ (β ∪ γ)
Dem.
⊢ . ✱22·34 . ⊃ ⊢ :: x ∈ {(α ∩ β) ∪ (α ∩ γ)} .≡ :. x ∈ α ∩ β .∨ . x ∈ α ∩ γ :.
[✱22·33] ≡ :. x ∈ α . x ∈ β .∨ . x ∈ α . x ∈ γ :.
[✱4·4] ≡ :. x ∈ α : x ∈ β .∨ . x ∈ γ :.
[✱22·34] ≡ :. x ∈ α . x ∈ β ∪ γ :.
[✱22·33] ≡ :. x ∈ α ∩ (β ∪ γ)  (1)
⊢ . (1) . ✱10·11 . ✱20·43 . ⊃ ⊢ . Prop
...
✱22·62. ⊢ : α ⊂ β .≡ . α ∪ β = β
Dem.
⊢ . ✱4·72 . ⊃ ⊢ :: x ∈ α .⊃ . x ∈ β : ≡ :. x ∈ α .∨ . x ∈ β :≡ . x ∈ β :.
[✱22·34] ≡ :. x ∈ α ∪ β .≡ . x ∈ β  (1)
⊢ . (1) . ✱10·271 . ⊃ ⊢ :: α ⊂ β .≡ :. x ∈ α ∪ β .≡ₓ. x ∈ β :.
[✱20·43] ≡ :. α ∪ β = β :: ⊃ ⊢ . Prop
...
✱22·91. ⊢ . α ∪ β = α ∪ (β − α)
Dem.
⊢ . ✱5·63 . ⊃ ⊢ :. x ∈ α .∨ . x ∈ β : ≡ : x ∈ α .∨ . x ∈ β . x ∼∈ α :.
[✱22·33·34·35] ⊃ ⊢ :. x ∈ α ∪ β .≡ : x ∈ α .∨ . x ∈ (β − α) :
[✱22·34] ≡ : x ∈ α ∪ (β − α)  (1)
⊢ . (1) . ✱10·11 . ✱20·43 . ⊃ ⊢ . Prop
...
✱22·59. ⊢ : α ⊂ γ . β ⊂ γ .≡ . α ∪ β ⊂ γ
Dem.
⊢ . ✱22·1 . ⊃ ⊢ :: Hp .≡ :. x ∈ α .⊃ₓ. x ∈ γ : x ∈ β .⊃ₓ. x ∈ γ :.
[✱10·22] ≡ :. (x) :. x ∈ α .⊃ . x ∈ γ : x ∈ β .⊃ . x ∈ γ :.
[✱4·77 . ✱10·271] ≡ :. (x) :. x ∈ α .∨ . x ∈ β : ⊃ . x ∈ γ :.
[✱22·34 . ✱10·413] ≡ :. (x) : x ∈ α ∪ β .⊃ . x ∈ γ :: ⊃ ⊢ . Prop
PM-VERBATIM-END PM1:✱22·59 -/
/- PM-VERBATIM-BEGIN PM1:✱22·6
✱22·6. ⊢ : x ε α ∪ β .≡ : α ⊂ γ . β ⊂ γ .⊃ᵧ. x ε γ
Dem.
⊢ . ✱22·59 . ⊃ ⊢ :. α ⊂ γ . β ⊂ γ .⊃ : x ∈ α ∪ β .⊃ . x ∈ γ :.
[Comm] ⊃ ⊢ :. x ∈ α ∪ β .⊃ : α ⊂ γ . β ⊂ γ .⊃ . x ∈ γ :.
[✱10·11·21] ⊃ ⊢ :. x ∈ α ∪ β .⊃ : α ⊂ γ . β ⊂ γ .⊃_γ. x ∈ γ  (1)
⊢ . ✱10·1 . ⊃ ⊢ :. α ⊂ γ . β ⊂ γ .⊃_γ. x ∈ γ :⊃ : α ⊂ α ∪ β . β ⊂ α ∪ β .⊃ . x ∈ α ∪ β :
[✱22·58] ⊃ : x ∈ α ∪ β  (2)
⊢ . (1) . (2) . ⊃ ⊢ . Prop
...
/- PM-VERBATIM-BEGIN PM1:✱22·89
✱22·89. ⊢ . (x) . x ∼ε (α − α)  [✱3·24]
PM-VERBATIM-END PM1:✱22·89 -/
/- PM-VERBATIM-BEGIN PM1:✱22·9
✱22·9. ⊢ . (α ∪ β) − β = α − β  [✱5·61]
PM-VERBATIM-END PM1:✱22·9 -/
/- PM-VERBATIM-BEGIN PM1:✱22·92
✱22·92. ⊢ : α ⊂ β .⊃ . β = α ∪ (β − α)  [✱22·91·62]
PM-VERBATIM-END PM1:✱22·92 -/
/- PM-VERBATIM-BEGIN PM1:✱22·93
✱22·93. ⊢ . α − β = α − (α ∩ β)
Dem.
⊢ . ✱4·73 . Transp . ⊃ ⊢ :. x ∈ α .⊃ : x ∼∈ β .≡ . ∼(x ∈ α . x ∈ β) .
[✱22.33] ≡ . x ∼∈ (α ∩ β) :.
[✱5·32] ⊃ ⊢ :. x ∈ α . x ∼∈ β .≡ . x ∈ α . x ∼∈ (α ∩ β) :.
[✱22·35·33] ⊃ ⊢ : x ∈ α − β .≡ . x ∈ α − (α ∩ β) :
[✱10·11 . ✱20·43] ⊃ ⊢ . α − β = α − (α ∩ β) . ⊃ ⊢ . Prop
PM-VERBATIM-END PM1:✱22·93 -/
/- PM-VERBATIM-BEGIN PM1:✱22·94
✱22·94. ⊢ : (α) . fα .≡ . (α) . f(−α)
Dem.
⊢ . ✱10·1 . ⊃ ⊢ : (α) . fα .⊃ . f(−α)
[✱10·11·21] ⊃ ⊢ : (α) . fα .⊃ . (α) . f(−α)  (1)
⊢ . ✱10·1 . ⊃ ⊢ : (α) . f(−α) .⊃ . f{−(−α)} .
[✱22·8 . ✱20·18] ⊃ . fα
[✱10·11·21] ⊃ ⊢ : (α) . f(−α) .⊃ . (α) . fα  (2)
⊢ . (1) . (2) . ⊃ ⊢ . Prop
PM-VERBATIM-END PM1:✱22·94 -/
/- PM-VERBATIM-BEGIN PM1:✱22·95
✱22·95. ⊢ : (∃α) . fα .≡ . (∃α) . f(−α)
Dem.
⊢ : ✱22·94 . ⊃ ⊢ : (α) . ∼fα .≡ . (α) . ∼f(−α)  (1)
⊢ . (1) . Transp . ✱20·6 . ⊃ ⊢ . Prop
PM-VERBATIM-END PM1:✱22·95 -/
