...
All five typed reconstructions pass strict Prop equivalence.  ·131 is converse
...
However, this is secondary evidence only: there is no Star2/T1–T9-style
assertion judgment or axiom-free inductive PM derivation, and no formal rule
unfolds the printed definitions while accounting for the cited propositions.
Every Prop proof closes from the displayed typed definitions, so its direct Lean
...
beyond print. All five therefore remain `prepared`, explicitly blocked at the
derivation layer. There is no partial promotion and no added axiom.
